...
sonatypeProfileName := "ai.tripl.arc-deltalake-pipeline-plugin"
...
scmInfo := Some(
  ScmInfo(
    url("https://github.com/tripl-ai/arc-deltalake-pipeline-plugin"),
    "scm:git@github.com:tripl-ai/arc-deltalake-pipeline-plugin.git"
  )
)
developers := List(
